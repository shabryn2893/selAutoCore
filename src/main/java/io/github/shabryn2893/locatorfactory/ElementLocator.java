 ...
 * 
 * @param <T> the type of the element to be located (e.g., WebElement in Selenium).
 */
public interface ElementLocator<T> {
     ...
     *
     * @param locatorType the type of the locator (e.g., "id", "xpath", "cssSelector").
     * @param locatorValue the value of the locator (e.g., the actual ID, XPath expression, or CSS selector).
     ...
     * @param locatorType the type of the locator (e.g., "id", "xpath", "cssSelector").
     * @param locatorValue the value of the locator (e.g., the actual ID, XPath expression, or CSS selector).
     * @return a list of located elements of type T, or an empty list if no elements are found.
     */
