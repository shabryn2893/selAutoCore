...
/**
 * Utility class for handling keyboard key mappings across different automation frameworks,
 * including Selenium and Playwright. Provides methods to retrieve key mappings for both frameworks.
 */
public class KeysName {
    ...
    /**
     * Retrieves the corresponding Selenium {@link Keys} enum value for a given key name.
     * 
     * @param keyName the name of the key (e.g., "ENTER", "TAB", "SHIFT").
     * @return the corresponding {@link Keys} enum value or {@code null} if the key is unsupported.
     */
     ...
     * 
     * @param keyName the name of the key (e.g., "ENTER", "TAB", "SHIFT").
     * @return the corresponding key string or {@code null} if the key is unsupported.
     */
    ...
    /**
     * Retrieves the key mapping (either Selenium or Playwright) based on the provided driver type.
     * If the driver object is an instance of {@link Page}, Playwright key mappings will be returned.
     * If the driver object is an instance of {@link WebDriver}, Selenium key mappings will be returned.
     * 
     * @param driverObject the driver object (either {@link Page} for Playwright or {@link WebDriver} for Selenium).
     * @param keyName the name of the key (e.g., "ENTER", "TAB", "SHIFT").
     * @return the corresponding key mapping as a string or {@code null} if the key or driver type is unsupported.
     */
